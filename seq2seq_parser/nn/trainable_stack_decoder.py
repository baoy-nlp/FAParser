...
from .attention import DotProductAttention as Attention
from .baseRNN import BaseRNN
from .trainable_stack import TrainableStack
...
class DecoderRNN(BaseRNN):
    ...
    def __init__(self,
        ...
        self.push_rnn = self.rnn_cell(input_size, hidden_size, n_layers, batch_first=True, dropout=dropout_p)
        self.pop_rnn = self.rnn_cell(input_size, hidden_size, n_layers, batch_first=True, dropout=dropout_p)

        self.rnn = TrainableStack(self.push_rnn, self.pop_rnn)
    ...
    def forward_step(self, input_var, hidden, encoder_outputs, function):
        ...
        output, hidden = self.rnn.forward(input_var, embedded, hidden)
