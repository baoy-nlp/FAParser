...
class Checkpoint(object):
    ...
    def delete_checkpoint(self, experiment_dir):
        path = self.update_latest_checkpoint(experiment_dir)
        if path is not None:
            shutil.rmtree(path)
    ...
    def save(self, experiment_dir):
        ...
        """
        self.delete_checkpoint(experiment_dir)
    ...
    @classmethod
    def update_latest_checkpoint(cls, experiment_path):
        checkpoints_path = os.path.join(experiment_path, cls.CHECKPOINT_DIR_NAME)
