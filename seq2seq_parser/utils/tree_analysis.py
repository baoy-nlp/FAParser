...
# from .tree_linearization import s2b_to_s2t
# from .tree_linearization import s2t_check
# from .tree_linearization import s2t_to_tree
...
if __name__ == '__main__':
    ...
    from tree_linearization import s2t_check
    from tree_linearization import s2t_to_tree
    from tree_linearization import s2t_fix
else:
    from .global_names import GlobalNames
    from .phrase_tree import FScore
    from .phrase_tree import PhraseTree
...
if __name__ == '__main__':
    ...
    # score, error = eval_file(sys.argv[1], sys.argv[2])
    # print(score)
    # print(error)
    # extract_origin_grammar(sys.argv[1], sys.argv[2])
    evaluate_grammar_coverage(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4])
