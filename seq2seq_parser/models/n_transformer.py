...
from seq2seq_parser.data.vocabulary import BOS, EOS, PAD
from seq2seq_parser.modules.basic import BottleLinear as Linear
from seq2seq_parser.modules.embeddings import Embeddings
from seq2seq_parser.modules.sublayers import PositionwiseFeedForward, MultiHeadedAttention
from seq2seq_parser.utils import nest
...
class NTransformer(nn.Module):
    ...
    def __init__(
        ...
        super(NTransformer, self).__init__()
    ...
    def batch_beam_search(self, src_seq, beam_size=5, max_steps=150):
        ...
        for t in range(max_steps):
            ...
            # beam_mask_ = next_word_ids.gt(EOS).float()
            # beam_mask = beam_mask * beam_mask_
